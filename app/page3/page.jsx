...
export default async function Page1() {
    ...
    return <>
        ...
        <div className='mx-12'>
            ...
            <div className='mt-12'>
                <h1 className='text-4xl mt-5'>normal Images without next/image and Fetching and Rendering Data on Serverside</h1>
            </div>
            <div className='flex'>
                <div className='mt-12 mr-2'>
                    <img src={img1} alt='Tree Image' width={200} height={150} />
                </div>
                <div className='mt-12 mr-2'>
                    <img src={img2} alt='Tree Image' width={200} height={150} />
                </div>
                <div className='mt-12 mr-2'>
                    <img src={img3} alt='Tree Image' width={200} height={150} />
                </div>
                <div className='mt-12 mr-2'>
                    <img src={img4} alt='Tree Image' width={200} height={150} />
                </div>
                <div className='mt-12 mr-2'>
                    <img src={img5} alt='Tree Image' width={200} height={150} />
                </div>
            </div>
